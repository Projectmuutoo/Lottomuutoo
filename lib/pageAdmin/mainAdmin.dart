...
import 'package:lottotmuutoo/models/response/lottoNoItemGetResponse.dart';
...
class _MainadminPageState extends State<MainadminPage> {
  ...
  Future<void> loadDataAsync() async {
    ...
    var res = lottoNoItemGetResponseFromJson(response.body);
    // แยกมี lotto ว่ามีหรือไม่มี
    if (res.response) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          //ถ้าหาก lotto ในระบบมี หรือ กดสุ่ม 100 ใบดูก่อนยืนยันลอตโต้เข้าระบบ
          if (lottot.isNotEmpty || _resultRand.isNotEmpty) {
            return Column(
              children: [
                Padding(
                        ...
                        children: [
                          Wrap(
                            ...
                            children: lottot.asMap().entries.map((entry) {
                              ...
                              return SizedBox(
                                width: width * 0.45, // ความกว้างของแต่ละคอลัมน์
                                child: Column(
                                  children: [
                                    Stack(
                                      children: [
                ...
                if (_resultRand.isNotEmpty && !acceptNumber100 && !isConfirmed)
                  ElevatedButton(
                    onPressed: () {
                      acceptNumber100 = true;
                      confirmNumRand();
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          const Color(0xff0288d1), // สีพื้นหลังของปุ่ม
